...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY",
    "dev-secret-key-change-me",  # valor padrão apenas para desenvolvimento
)

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get("DJANGO_DEBUG", "True") == "True"

# Ex.: DJANGO_ALLOWED_HOSTS="localhost,127.0.0.1,meusite.com.br"
...
# Suporte para DATABASE_URL (usado por Railway, Render, Heroku, etc.)
DATABASE_URL = os.environ.get("DATABASE_URL")

if DATABASE_URL:
    # Se DATABASE_URL estiver definido, usar dj-database-url
    try:
    ...
    # Configuração padrão usando variáveis individuais
    DATABASES = {
        "default": {
            "ENGINE": "django.db.backends.postgresql",
            "NAME": os.environ.get("POSTGRES_DB", "sistema_carros"),
...
# Ajustado para contexto brasileiro; pode ser sobrescrito via ambiente, se desejar
...
LOGIN_REDIRECT_URL = '/logista/'
LOGOUT_REDIRECT_URL = '/logista/login/'

# Configurações de sessão para manter login entre áreas
SESSION_COOKIE_AGE = 86400  # 24 horas em segundos
SESSION_COOKIE_SECURE = os.environ.get("DJANGO_SESSION_COOKIE_SECURE", "False") == "True"  # True em produção com HTTPS
